package it.tim.reload.controller.component;
...
public class DiagnosticsComponent implements Ordered {
	...
	private static final Logger logger = LoggerFactory.getLogger(it.tim.reload.controller.component.DiagnosticsComponent.class);
	
	
	@SuppressWarnings("unchecked")
	@Around("execution(* it.tim.reload.web.ReloadController.*(..))")
